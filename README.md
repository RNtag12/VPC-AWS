# VPC-AWS
This is a guide to how you can deploy a Highly secure, available, and scalable web application on AWS. it features a VPC architecture in AWS with two public subnets and four private subnets.
